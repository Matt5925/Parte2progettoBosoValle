...
import GestioneBanca.Portafoglio;
...
import static org.junit.jupiter.api.Assertions.*;
    ...
    public class PortafoglioTest {
        ...
        public void testAggiungiDenaro() {
            ...
            assertEquals(1500.0, portafoglio.getSaldo(), "Il saldo dopo l'aggiunta di denaro dovrebbe essere 1500.0");
        }
        ...
        public void testPrelevaDenaroConSaldoInsufficiente() {
            ...
            assertEquals(1000.0, portafoglio.getSaldo(), "Il saldo non dovrebbe cambiare dopo un prelievo fallito.");
        }

        @Test
        public void testToString() {
            // Verifica che la rappresentazione in stringa del portafoglio sia corretta
            assertEquals("1000.0", portafoglio.tostring(), "Il metodo toString dovrebbe restituire il saldo corretto come stringa.");
        }
    }
