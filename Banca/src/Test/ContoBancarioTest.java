package Test;
import GestioneBanca.ContoBancario;
...
import org.junit.jupiter.api.Test;
    ...
    public class ContoBancarioTest {
        ...
        public void testPrelevaConSaldoInsufficiente() {
            ...
            assertEquals(100.0, conto.getSaldo(), "Il saldo non dovrebbe cambiare dopo un prelievo fallito.");
        }

        @Test
        public void testToString() {
            // Verifica che il metodo toString restituisca il saldo come stringa
            assertEquals("100.0", conto.tostring(), "Il metodo toString dovrebbe restituire il saldo corretto come stringa.");
        }
    }
