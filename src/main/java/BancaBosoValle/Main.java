    ...
    do {
      ...
      switch (scelta) {
        ...
        case 3:
          {
            System.out.print(
                "Soldi nel Conto Bancario: " + utente.getContoBancario().getSaldo() + "\n");
        ...
        case 4:
          {
            ...
            do {
              ...
              if (rischio.equalsIgnoreCase("Basso")
                  || rischio.equalsIgnoreCase("Medio")
