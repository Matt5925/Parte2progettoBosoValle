...
import GestioneBanca.Investimento;
...
import static org.junit.jupiter.api.Assertions.*;
    ...
    public class InvestimentoTest {
        ...
        @BeforeEach
        public void setUp() {
            // Creiamo un nuovo investimento con 1000€ di importo, durata "Medio", rischio "Alto", e 6 mesi rimanenti
        ...
        public void testCreazioneInvestimento() {
            ...
            assertEquals(1000.0, investimento.getImporto(), "L'importo dell'investimento dovrebbe essere 1000€.");
            assertEquals("Medio", investimento.getDurata(), "La durata dell'investimento dovrebbe essere 'Medio'.");
            assertEquals("Alto", investimento.getRischio(), "Il rischio dell'investimento dovrebbe essere 'Alto'.");
        }
        ...
        public void testAggiornaInvestimento() {
            ...
            assertEquals(5, investimento.getMesiRimanenti(), "I mesi rimanenti dovrebbero essere 5 dopo un aggiornamento.");
        ...
        public void testCalcolaGuadagno() {
            ...
            assertEquals(0.0, investimento.calcolaGuadagno(), "Il guadagno dovrebbe essere 0 se l'investimento non è completato.");
            ...
            assertTrue(guadagno > 0, "Il guadagno dovrebbe essere positivo dopo che l'investimento è completato.");
        }
        ...
        public void testToString() {
            ...
            assertTrue(investimento.toString().startsWith(expectedString), "Il metodo toString dovrebbe restituire una stringa corretta.");
        }
